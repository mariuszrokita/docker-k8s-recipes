...
1. `docker inspect <container_id>` - display detailed information on container
1. `docker inspect --format='{{json .State.Health}}' <container_id>` - display info only about container health